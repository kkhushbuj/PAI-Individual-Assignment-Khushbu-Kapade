...
## Task 1 - The project is implemented entirely in Python and follows a modular design (Branch: main-for-task-1):
...
## Task 2 – Market Basket Analysis Using Statistical Methods (Branch: main-for-task-2):
